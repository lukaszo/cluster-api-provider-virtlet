...
//+kubebuilder:rbac:groups=virtlet.k8s.io,resources=virtletclusterproviderspecs;virtletclusterproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
